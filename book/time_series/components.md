...
```{figure} https://github.com/TUDelft-MUDE/source-files/raw/main/file/time_series.png
:name: time_series
:width: 700px
:align: center
...
```{figure} https://github.com/TUDelft-MUDE/source-files/raw/main/file/trend.png
:name: trend
:width: 600px
:align: center
...
```{figure} https://github.com/TUDelft-MUDE/source-files/raw/main/file/offset.png
:name: offset
:width: 700px
:align: center
