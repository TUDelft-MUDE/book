...
```{figure} https://github.com/TUDelft-MUDE/source-files/raw/main/file/GOF_data.png
...
```{figure} https://github.com/TUDelft-MUDE/source-files/raw/main/file/QQplot.png
---
scale: 75%
name: rating_curve
...
```{figure} https://github.com/TUDelft-MUDE/source-files/raw/main/file/log-scale.png
---
name: log-scale
---
...
```{figure} https://github.com/TUDelft-MUDE/source-files/raw/main/file/sketch_KS.png
---
name: KS
---
...
```{figure} https://github.com/TUDelft-MUDE/source-files/raw/main/file/GOF_ex.png
