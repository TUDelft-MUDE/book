...
```{figure} https://github.com/TUDelft-MUDE/source-files/raw/main/file/data_overview.png
---
scale: 100%
name: data_wind
...
```{figure} https://github.com/TUDelft-MUDE/source-files/raw/main/file/ecdf_wind.png
---
scale: 75%
name: ecdf
...
```{figure} https://github.com/TUDelft-MUDE/source-files/raw/main/file/epdf_wind.png
---
scale: 75%
name: epdf
