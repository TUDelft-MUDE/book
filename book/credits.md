...
>
> Figures {numref}`pdf_cdf`, {numref}`pdf_cdf_2`, {numref}`density_scatter`, {numref}`density_scatter_2` and {numref}`density_scatter_3` are created by Max Ramgraber ([maxramgraber.com/interactive](https://www.maxramgraber.com/interactive)).
