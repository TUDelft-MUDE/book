...
> {ref}`Propagation of Uncertainty <01_errorprop>` is modified by Lotfi based on the original version from Sandra Verhagen.
>
> Special thanks goes to:
> - The lecture notes _Probability and Observation Theory_ by P.J.G. Teunissen, D.G. Simons, C.C.J.M. Tiberius (2009) that provided the framework for this chapter.
>
