...
```{figure} https://github.com/TUDelft-MUDE/source-files/raw/main/file/samples_asymptotic.png
...
```{figure} https://github.com/TUDelft-MUDE/source-files/raw/main/file/hist_cdf_asymptotic.png
