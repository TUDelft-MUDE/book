...
```{figure} https://github.com/TUDelft-MUDE/source-files/raw/main/file/asymptotic_sampling.png
...
```{figure} https://github.com/TUDelft-MUDE/source-files/raw/main/file/asymptotic_hist.png
