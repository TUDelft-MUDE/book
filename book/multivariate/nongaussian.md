...
```{figure} https://github.com/TUDelft-MUDE/source-files/raw/main/file/copula_samples_together.png
...
```{figure} https://github.com/TUDelft-MUDE/source-files/raw/main/file/examples_copulas.png
