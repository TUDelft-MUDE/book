...
```{figure} https://github.com/TUDelft-MUDE/source-files/raw/main/file/09_chi2.png
---
height: 250px
name: chi2
---
...
```{figure} https://github.com/TUDelft-MUDE/source-files/raw/main/file/09_outlier.png
---
height: 300px
name: outlier
---
