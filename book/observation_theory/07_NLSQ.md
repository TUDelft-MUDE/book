...
```{figure} https://github.com/TUDelft-MUDE/source-files/raw/main/file/07_volcano_obs.png
---
height: 300px
name: volcano_obs
---
...
```{figure} https://github.com/TUDelft-MUDE/source-files/raw/main/file/07_gn.png
---
height: 250px
name: gn
---
