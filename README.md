...
2. Visit [zenodo.org/records/16223061](https://zenodo.org/records/16223061) and create a new (draft!) version of the HTML files record. Manually update the version number and URL's in the description when the academic year (`A`) changes. Generate a new DOI by clicking the buttom "Get a DOI now," which will be used in the following step.
