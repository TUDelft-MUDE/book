...
The released book can be found on on https://mude.citg.tudelft.nl/book/. This page shows the built book of the `2025` branch (the beginning of upcoming academic year). All branches will also be visible as seen in the action's summaries: https://github.com/TUDelft-MUDE/book/actions
